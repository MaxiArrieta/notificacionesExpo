...
const comparar = (nuevaNotificacion) => {
            ...
            if (notificacion.mensaje.to === nuevaNotificacion.mensaje.to) {
                ...
                if (notificacion.mensaje.body === nuevaNotificacion.mensaje.body) {
                    ...
                    if (notificacion.time === nuevaNotificacion.time) {
                        // Si es true es xq esta en el array entonces
                        // paso el estaEnElArray como true
                        estaEnElArray = true;
                        console.log('***************************************************');
    ...
    // Si estaEnElArray es false, lo agrogo al array
    // si es treu es xq ya esta entonces no lo agrego xq sino
    // lo tengo 2 veces
    if (!estaEnElArray) {
